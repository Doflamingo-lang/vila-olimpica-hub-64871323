            ...
            <AccordionContent className="pt-2 pb-4 space-y-4">
              ...
              <div className="space-y-3">
                {[
                  ...
                  { icon: <CreditCard className="w-4 h-4" />, title: "Pagamentos", desc: "Visualize as taxas condominiais pendentes e efectue pagamentos. Para cada pagamento, seleccione o método (M-Pesa, e-Mola ou Cartão Visa) e introduza os dados necessários." },
            ...
            <AccordionContent className="pt-2 pb-4 space-y-3">
              <Accordion type="multiple" className="space-y-2">
                {[
                  ...
                  { q: "Como pago a taxa condominial?", a: "Na Área do Morador, aceda à secção Pagamentos. Seleccione a taxa pendente, escolha o método de pagamento (M-Pesa, e-Mola ou Cartão Visa), introduza os dados necessários e confirme." },
